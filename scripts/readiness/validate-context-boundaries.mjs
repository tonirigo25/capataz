...
if (fixture) {
  ...
  if (routes.length !== 37) failures.push(`expected 37 routes, found ${routes.length}`);
  ...
  if (jobRoutes.length !== 6) failures.push(`expected 6 job route boundaries, found ${jobRoutes.length}`);
}
