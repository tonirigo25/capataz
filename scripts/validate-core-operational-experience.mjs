...
const cases = [
  ...
  ["ficha de cliente conserva Capataz contextual", files.client.includes("Preguntar a Capataz") && files.client.includes("/capataz")],
  ["obras comparte búsqueda, filtros y resumen", ["FilterBar", "SearchInput", "ResultSummary"].every((name) => files.works.includes(name))],
  ["ficha de obra conserva resumen y Capataz", files.work.includes("EntityWorkflowSummary") && files.work.includes("Preguntar en Capataz")],
