...
if(mode==="integrations"){has("app/(app)/hoy/page.tsx",["buildTodayDashboard","limit: query.categoria ? 20 : 3","getAgendaItems","getEconomicControl"]);for(const p of ["clientes","obras","dinero","presupuestos"])has(`app/(app)/${p}/[id]/page.tsx`,["EntityWorkflowSummary"])}
