...
check("Más escritorio elimina destinos ya visibles sin ocultar Compras", chrome.includes("destinationsShownElsewhere") && chrome.includes('"/tesoreria"') && chrome.includes('"/equipos"') && navigation.includes('label: "Compras"'));
