...
async function main() {
  ...
  await prisma.empresa.create({
    data: {
      id: "empresa-demo",
      nombreComercial: "Reformas Horizonte Demo",
      razonSocial: "Reformas Horizonte Demo SL",
      nifCif: "B12345678",
      ...
      email: "hola@reformashorizonte.example",
      web: "https://reformashorizonte.example",
      ...
      logoUrl: "/icons/orqena.svg",
      selloUrl: "/icons/orqena.svg",
      colorMarca: "#f6c945",
      ivaDefecto: 21,
