...
const productColumns: readonly MenuColumn[] = [
  {
    ...
    items: [
      { label: "Clientes", href: "/soluciones/clientes-y-presupuestos", icon: Users },
      { label: "Seguimientos", href: "/soluciones/clientes-y-presupuestos", icon: ClipboardCheck },
      { label: "Presupuestos", href: "/soluciones/clientes-y-presupuestos", icon: FileText },
      { label: "Facturas", href: "/soluciones/facturacion-y-cobros", icon: ReceiptText },
      { label: "Cobros", href: "/soluciones/facturacion-y-cobros", icon: WalletCards },
    ],
  },
  {
    ...
    items: [
      { label: "Obras y trabajos", href: "/soluciones/obras-y-trabajo", icon: BriefcaseBusiness },
      { label: "Agenda", href: "/soluciones/equipo-y-agenda", icon: CalendarDays },
      { label: "Tareas", href: "/soluciones/obras-y-trabajo", icon: ClipboardCheck },
      { label: "Equipo", href: "/soluciones/equipo-y-agenda", icon: Users },
      { label: "Evidencias", href: "/soluciones/obras-y-trabajo", icon: FolderKanban },
    ],
  },
  {
    ...
    items: [
      { label: "Proveedores", href: "/soluciones/proveedores-y-subcontratas", icon: Building2 },
      { label: "Subcontratas", href: "/soluciones/proveedores-y-subcontratas", icon: BriefcaseBusiness },
      { label: "Facturas recibidas", href: "/soluciones/documentos-y-ocr", icon: ReceiptText },
      { label: "OCR documental", href: "/soluciones/documentos-y-ocr", icon: ScanText },
      { label: "Gastos", href: "/soluciones/control-costes-y-margen", icon: CircleDollarSign },
    ],
  },
  {
    ...
    items: [
      { label: "Tesorería", href: "/soluciones/control-costes-y-margen", icon: Landmark },
      { label: "Rentabilidad", href: "/soluciones/control-costes-y-margen", icon: BarChart3 },
      { label: "Alertas", href: "/soluciones/ia-operativa", icon: Sparkles },
      { label: brand.assistantName, href: "/soluciones/ia-operativa", icon: Bot },
      { label: "Automatizaciones", href: "/soluciones/ia-operativa", icon: Sparkles },
    ],
  },
] as const;
