...
export const capabilityCatalog = {
  ...
  "company.billing.manage": meta(
    "company",
    "billing.manage",
    "Gestionar plan y suscripción",
    "critical",
  ),
  "company.members.view": meta(
    "company",
    "members.view",
    "Ver miembros",
    "normal",
  ),
  "company.members.invite": meta(
    "company",
    "members.invite",
    "Invitar miembros",
    "sensitive",
  ...
  "sales.budgets.create": meta(
    "sales",
    "budgets.create",
    "Crear presupuestos",
    "normal",
  ),
  "sales.budgets.update": meta(
    "sales",
    "budgets.update",
    "Editar presupuestos",
    "normal",
  ),
  "sales.budgets.approve": meta(
    "sales",
    "budgets.approve",
  ...
  "sales.budgets.send": meta(
    "sales",
    "budgets.send",
    "Preparar envío de presupuestos",
    "sensitive",
    undefined,
    true,
  ),
  "sales.pricing.view": meta(
    "sales",
    "pricing.view",
    "Ver precios de venta",
    "normal",
  ),
  "sales.discount.apply": meta(
    "sales",
    "discount.apply",
  ...
  "sales.invoices.create": meta(
    "sales",
    "invoices.create",
    "Crear facturas",
    "sensitive",
  ),
  "sales.invoices.issue": meta(
    "sales",
    "invoices.issue",
    "Emitir facturas",
    "critical",
  ...
  "sales.invoices.send": meta(
    "sales",
    "invoices.send",
    "Preparar envío de facturas",
    "sensitive",
    undefined,
    true,
  ),
  "purchases.suppliers.view": meta(
    "purchases",
    "suppliers.view",
    "Ver proveedores",
    "normal",
  ),
  "purchases.suppliers.manage": meta(
    "purchases",
    "suppliers.manage",
    "Gestionar proveedores",
    "normal",
  ),
  "purchases.received_invoices.view": meta(
    "purchases",
    "received_invoices.view",
    "Ver facturas recibidas",
    "sensitive",
  ),
  "purchases.received_invoices.manage": meta(
    "purchases",
    "received_invoices.manage",
    "Gestionar facturas recibidas",
    "sensitive",
  ),
  "purchase_cost.view": meta(
    "economy",
    "purchase_cost.view",
    "Ver coste de compra",
    "sensitive",
  ),
  "internal_cost.view": meta(
    "economy",
    "internal_cost.view",
    "Ver coste interno",
    "sensitive",
  ),
  "margin_percent.view": meta(
    "economy",
    "margin_percent.view",
    "Ver margen porcentual",
    "sensitive",
  ),
  "margin_amount.view": meta(
    "economy",
    "margin_amount.view",
    "Ver margen absoluto",
    "sensitive",
  ),
  "profitability.view": meta(
    "economy",
    "profitability.view",
    "Ver rentabilidad",
    "sensitive",
  ),
  "project_budget_control.view": scoped(
    "economy",
    "project_budget_control.view",
    "Ver control presupuestario del trabajo",
  ),
  "treasury.view": meta("treasury", "view", "Ver tesorería", "sensitive"),
  "treasury.manage": meta(
    "treasury",
    "manage",
    "Gestionar tesorería",
    "critical",
  ),
  "treasury.payments.register": meta(
    "treasury",
    "payments.register",
    "Registrar pagos",
    "sensitive",
  ),
  "treasury.collections.register": meta(
    "treasury",
    "collections.register",
    "Registrar cobros",
    "sensitive",
  ),
  "banking.view": meta("treasury", "banking.view", "Ver banca", "critical"),
  "tax.view": meta("treasury", "tax.view", "Ver fiscalidad", "sensitive"),
  "documents.view": scoped("documents", "view", "Ver documentos"),
  "documents.upload": meta("documents", "upload", "Subir documentos", "normal"),
  "documents.manage": meta(
    "documents",
    "manage",
  ...
  "orqena.execute": meta(
    "orqena",
    "execute",
    "Confirmar acciones de Orqena",
    "sensitive",
    "orqena_actions",
    true,
  ),
  "orqena.memory.manage": meta(
    "orqena",
    "memory.manage",
    "Gestionar memoria",
    "sensitive",
...
function scoped(
  ...
  return {
    ...meta(domain, action, description, "normal"),
    supportsScope: true,
  };
}
...
// Non-company scopes only apply to capabilities backed by work/client/document relations.
export const scopeAssignableCapabilityKeys = [
  "clients.view",
  "clients.update",
  "work.view",
  "work.update",
...
const operational = Object.keys(capabilityCatalog).filter(
  (key) =>
    !key.startsWith("company.billing") &&
    !key.includes("members.remove") &&
    !economicPrefixes.some((prefix) => key.startsWith(prefix)),
) as CapabilityKey[];
...
> = {
  ...
  ADMIN: operational,
  MANAGER: operational.filter(
    (key) =>
      !key.startsWith("company.") ||
      key === "company.view" ||
      key === "company.members.view",
  ),
  MEMBER: [
    "company.view",
    "clients.view",
