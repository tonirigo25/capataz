...
export const routeExperienceManifest: RouteExperienceRule[] = [
  ...
  rule("public-commercial", /^\/(?:planes|precios|empresa|recursos|seguridad|contacto)$/, { ...publicShared, family: "marketing", shell: "marketing", access: "public", title: "Información comercial", primaryAction: "Solicitar acceso", empty: "not-applicable", screenshotGroup: "public" }),
  ...
  rule("opportunities", /^\/oportunidades$/, { ...shared, family: "list", shell: "app", access: "capability", title: "Oportunidades", primaryAction: "Revisar pipeline", mobile: "native-list", empty: "guided", screenshotGroup: "lists" }),
  ...
  rule("client-record-view", /^\/clientes\/\[id\]\/\[\.\.\.view\]$/, { ...shared, family: "record", shell: "app", access: "capability", title: "Cliente 360", primaryAction: "Siguiente acción", mobile: "record-page", empty: "guided", archive: "available", destructiveConfirmation: "required", screenshotGroup: "records" }),
  ...
  rule("work-record-section", /^\/obras\/\[id\]\/\[\.\.\.section\]$/, { ...shared, family: "record", shell: "app", access: "capability", title: "Trabajo 360", primaryAction: "Registrar avance", mobile: "record-page", empty: "guided", archive: "available", destructiveConfirmation: "required", screenshotGroup: "records" }),
  rule("work-compatibility-alias", /^\/trabajo$/, { ...shared, family: "list", shell: "app", access: "capability", title: "Trabajos", primaryAction: "Abrir trabajos", mobile: "native-list", empty: "guided", archive: "available", screenshotGroup: "lists" }),
  ...
  rule("document-upload", /^\/documentos\/subir$/, { ...shared, family: "form", shell: "app", access: "capability", title: "Subir documento", primaryAction: "Guardar documento", mobile: "sheet-form", empty: "not-applicable", screenshotGroup: "records" }),
  ...
  rule("orqena-ai", /^\/orqena-ia(?:\/\[module\])?$/, { ...shared, family: "assistant", shell: "app", access: "capability", title: "Orqena IA", primaryAction: "Revisar recomendación", empty: "guided", screenshotGroup: "control" }),
