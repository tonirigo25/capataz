...
export const routeExperienceManifest: RouteExperienceRule[] = [
  ...
  rule("public-guided-demo-preview", /^\/demo-v2$/, { ...shared, family: "marketing", shell: "standalone", access: "public", title: `Prueba ${brand.productName} — Demostración guiada`, primaryAction: "Recorrer demostración", empty: "not-applicable", screenshotGroup: "public" }),
  rule("public-product", /^\/(?:producto(?:\/\[modulo\])?|soluciones(?:\/\[solucion\])?)$/, { ...shared, family: "marketing", shell: "marketing", access: "public", title: "Producto", primaryAction: "Explorar demo", empty: "not-applicable", screenshotGroup: "public" }),
  ...
  rule("public-legal-support", /^\/(?:privacidad|politicas|terminos|cookies|soporte|estado|recursos\/(?:calculadora-margen-obra|checklist-factura-recibida))$/, { ...shared, family: "marketing", shell: "marketing", access: "public", title: "Información", primaryAction: "Volver", empty: "not-applicable", screenshotGroup: "public" }),
  ...
  rule("settings", /^\/(?:configuracion(?:\/(?:ia|importar|memoria|preferencias|privacidad|seguridad|soporte(?:\/ayuda)?))?|plan-y-uso)$/, { ...shared, family: "settings", shell: "app", access: "membership", title: "Configuración", primaryAction: "Guardar", mobile: "sheet-form", empty: "not-applicable", screenshotGroup: "control" }),
  ...
  rule("platform", /^\/plataforma(?:\/(?:observabilidad|salud))?$/, { ...shared, family: "platform", shell: "app", access: "platform", title: "Plataforma interna", primaryAction: "Revisar", empty: "guided", screenshotGroup: "control" }),
];
